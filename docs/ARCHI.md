...
| 1 General | `v0.2.0` | **In progress** — landed through `v0.1.40`: the leaves' slice-1 rows. What remains is the board's: the pre-launch release on the critical path to the tag, the turn harness's decline form | [`archi/host.md`](archi/host.md) (the profile and its memory table), [`archi/render-apply.md`](archi/render-apply.md), [`archi/engine-frontend.md`](archi/engine-frontend.md), [`archi/stack.md`](archi/stack.md), [`archi/tools.md`](archi/tools.md), [`archi/tests.md`](archi/tests.md) |
