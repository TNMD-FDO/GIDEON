...
├── eval/                    # reference/ (empty skeleton, §18.5); seed/prototype-qa/ (frozen harvest tooling, ruff-excluded, do not modify); sets/eval-v1/ (the eval set's cases by suite — judgments/, build-gates/ — and its frozen slices, slices/<name>/<file>.ids; archi/eval.md);
...
| `eval run --slice <name> [--set <dir>]` (`evaluation/command.py`) · `python3 -m tools.variants` | [`archi/eval.md`](archi/eval.md) |
