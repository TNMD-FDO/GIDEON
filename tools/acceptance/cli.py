...
from tools.acceptance.run import STAGE_IDENTIFIERS, STAGES, run
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--name", default=DEFAULT_VM_NAME, metavar="VM")
...
def main(
    ...
    *,
    ...
    output = (
        ...
        else default_out(options.ref, options.name)
    )
    ...
    spec = RunSpec(
        ...
        run_dir=HARNESS_ROOT / options.name,
        out=output,
        keep=options.keep,
        until=options.until,
    )
