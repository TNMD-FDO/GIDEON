...
This file enumerates those components. **Nothing is pinned yet** — the
skeleton ships no images and no models. Each release that pins a component in
`images.lock` or `models.lock` adds its entry here.
